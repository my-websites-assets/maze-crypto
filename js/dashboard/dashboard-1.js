...
(function($) {
 ...
 var dzChartlist = function(){
    ...
    var TotalWithdrawalsChart = function () {
        var options = {
            series: [
                {
                    name: 'Net Profit',
        ...
        var chartBar1 = new ApexCharts(document.querySelector("#TotalWithdrawalsChart"), options);
        chartBar1.render();
	...
	var TotalReserveChart = function(){
		var options = {
		  series: [
			{
				name: 'Net Profit',
		...
		var chartBar1 = new ApexCharts(document.querySelector("#TotalReserveChart"), options);
		chartBar1.render();
