...
(function ($) {
    ...
    versionSelect.on('change', function () {
        ...
        /* if(this.value === 'dark'){
            //jQuery(".nav-header .logo-abbr").attr("src", "https://cdn.jsdelivr.net/gh/my-websites-assets/maze-crypto/images/logo-white.png");
            jQuery(".nav-header .logo-compact").attr("src", https://cdn.jsdelivr.net/gh/my-websites-assets/maze-crypto/images/logo-text-white.png");
            jQuery(".nav-header .brand-title").attr("src", https://cdn.jsdelivr.net/gh/my-websites-assets/maze-crypto/images/logo-text-white.png");
        	
            setCookie('logo_src', 'https://cdn.jsdelivr.net/gh/my-websites-assets/maze-crypto/images/logo-white.png');
            setCookie('logo_src2', https://cdn.jsdelivr.net/gh/my-websites-assets/maze-crypto/images/logo-text-white.png');
        }else{
            jQuery(".nav-header .logo-abbr").attr("src", "https://cdn.jsdelivr.net/gh/my-websites-assets/maze-crypto/images/logo.png");
            jQuery(".nav-header .logo-compact").attr("src", https://cdn.jsdelivr.net/gh/my-websites-assets/maze-crypto/images/logo-text.png");
            jQuery(".nav-header .brand-title").attr("src", https://cdn.jsdelivr.net/gh/my-websites-assets/maze-crypto/images/logo-text.png");
        	
            setCookie('logo_src', 'https://cdn.jsdelivr.net/gh/my-websites-assets/maze-crypto/images/logo.png');
            setCookie('logo_src2', https://cdn.jsdelivr.net/gh/my-websites-assets/maze-crypto/images/logo-text.png');
        } */
